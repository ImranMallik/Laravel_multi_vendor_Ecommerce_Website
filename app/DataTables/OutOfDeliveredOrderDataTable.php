...
use App\Models\OutOfDeliveredOrder;
...
class OutOfDeliveredOrderDataTable extends DataTable
{
    /**
    ...
    {
        return $model->where('order_status', 'out_of_delivery')->newQuery();
    }
    ...
    {
        return $this->builder()
            ->setTableId('outofdeliveredorder-table')
    ...
    {
        return 'OutOfDeliveredOrder_' . date('YmdHis');
    }
}
