                        ...
                        <div class="form-group">
                            @php
                                $subCategories = \App\Models\SubCategory::where(
                                    'category_id',
                                    $productSliderSectionOne->category,
                                )->get();
                            @endphp
                            ...
                            <select name="sub_cat_one" class="form-control sub-category">
                                ...
                                @foreach ($subCategories as $subCategory)
                                    <option
                                        {{ $subCategory->id == $productSliderSectionOne->sub_category ? 'Selected' : '' }}
                        ...
                        <div class="form-group">
                            @php
                                $childCategories = \App\Models\ChildCategory::where(
                                    'sub_category_id',
                                    $productSliderSectionOne->sub_category,
                                )->get();
                            @endphp
                            ...
                            <select name="child_cat_one" class="form-control child-category">
                                ...
                                @foreach ($childCategories as $childCategory)
                                    <option
                                        {{ $childCategory->id == $productSliderSectionOne->child_category ? 'Selected' : '' }}
